...
def view_detection(view_coords,view_scores,roi):
	...
	for person in range(0,roi):
		...
		if ((((nose_x+38 > left_shoulder_x and nose_x+38 > right_shoulder_x) and (left_ear_score >= 0.1 and right_ear_score >= 0.1)))  or ( left_ear_score < 0.1 and right_ear_score >= 0.1 and left_eye_score >= 0.1 and  right_eye_score >= 0.1 and (nose_x+38 > left_shoulder_x and nose_x+38 > right_shoulder_x) and ((right_shoulder_x - right_eye_x) < 10))) :
